<template>
    <div id="AppCapsuleMenu" style="position: relative;">
        <div class="display-flex">
            <div @click="onShow" :class="'card-capsule ' + status + ' ' + (visiblePopup ? 'box box-shadow' : '')" style="cursor: pointer; padding-top: 2px; padding-bottom: 2px;">
                {{ title ? title : 'Menu' }}
            </div>
        </div>
        <div v-if="visiblePopup" class="card border-full box-shadow" style="position: absolute; top: 25px; left: 0; width: 150px; z-index: 10; padding: 0 0; border-radius: 5px; background-color: #fff; max-height: 200px; overflow-y: auto;">
